...
class TvshortSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for info_dict in rdict['subject']:
            ...
            yield scrapy.Request(url=short_url, meta={'subject_id': subject_id}, callback=self.parse2)
    ...
    def parse2(self, response):
        ...
        for page in range(max_page):
            ...
            yield scrapy.Request(url=url, meta={'subject_id': subject_id}, callback=self.parse3)
